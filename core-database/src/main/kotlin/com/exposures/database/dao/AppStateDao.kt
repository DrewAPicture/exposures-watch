...
interface AppStateDao {
     ...
     * ever produced by a spot-metered film medium, and [focalLengthMm] only by a ZOOM lens — saving
     * an exposure without one (PRIME lens, or a film medium with no light meter) must not wipe out
     * the last real choice, unlike the other fields which are unconditionally required and so
     * always have a fresh value to write.
     */
    @Query(
        """
